...
from subscriptions.models import SubscriptionsModel, UserPaymentOrderModel, UserSubscriptionModel
...
def GetSubscriptionsPlanInfoAPI(request):
    ...
    for subscription in subscriptions:
        ...
        data['features'] = [
            {
                "name": get_field_verbose_name('number_of_employees'),
                "type": "num",
                "value": subscription.number_of_employees
            },
            {
                "name": get_field_verbose_name('manage_employee'),
                "type": "bool",
                "value": subscription.manage_employee
            },
            {
                "name": get_field_verbose_name('manage_recruitment'),
                "type": "bool",
                "value": subscription.manage_recruitment
            },
            {
                "name": get_field_verbose_name('manage_onboarding'),
                "type": "bool",
                "value": subscription.manage_onboarding
            },
            {
                "name": get_field_verbose_name('manage_attendance'),
                "type": "bool",
                "value": subscription.manage_attendance
            },
            {
                "name": get_field_verbose_name('payroll_management'),
                "type": "bool",
                "value": subscription.payroll_management
            },
            {
                "name": get_field_verbose_name('leave_management'),
                "type": "bool",
                "value": subscription.leave_management
            },
            {
                "name": get_field_verbose_name('manage_assets'),
                "type": "bool",
                "value": subscription.manage_assets
            },
            {
                "name": get_field_verbose_name('pms_management'),
                "type": "bool",
                "value": subscription.pms_management
            },
            {
                "name": get_field_verbose_name('manage_Offboarding'),
                "type": "bool",
                "value": subscription.manage_Offboarding
            },
            {
                "name": get_field_verbose_name('manage_helpdesk'),
                "type": "bool",
                "value": subscription.manage_helpdesk
            },
            {
                "name": get_field_verbose_name('employee_attendance_report'),
                "type": "bool",
                "value": subscription.employee_attendance_report
            },
            {
                "name": get_field_verbose_name('employee_salary_report'),
                "type": "bool",
                "value": subscription.employee_salary_report
            },
            {
                "name": get_field_verbose_name('employee_leave_report'),
                "type": "bool",
                "value": subscription.employee_leave_report
            },
            {
                "name": get_field_verbose_name('performance_review_report'),
                "type": "bool",
                "value": subscription.performance_review_report
            },
            {
                "name": get_field_verbose_name('send_email_notifications'),
                "type": "bool",
                "value": subscription.send_email_notifications
            },
            {
...
from parent_base.models import ParentOrganization
@csrf_exempt
def AddHRByAPI(request):
    error_msgs = []
    if request.method == 'POST':
        ...
        if not users.exists():
            if not User.objects.filter(email=email).exists() and not Employee.objects.filter(email=email).exists():
                hospital = ParentOrganization.objects.create()
                hospital.name = organization_name
                hospital.contact_email = email
                ...
                employee.parent = hospital
                employee.badge_id = f'PEP_{username}'
                ...
                error_msgs.append('يوجد من قبل نفس البريد الألكتروني')
        else:
...
def GetHRManagementInfo(request, id):
    ...
    data = {
        ...
        'subscription':{
            ...
            'end_date': (subscription.get_expiry_date.strftime("%Y-%m-%d")),
            'has_subscription':employee.has_subscription,
        },
    }
...
def DeleteHRManagementAPI(request, id):
    user = User.objects.get(id=id)
    user_employee = user.employee_get
    parent= user_employee.parent
    subscription = parent.subscription
    employees = Employee.objects.filter(parent=parent)
...
def RenewSubscription(request, user_id):
    ...
    if request.method == 'POST':
        ...
        user_subscription.save()
        parent.subscription = user_subscription
        parent.save()
        return JsonResponse({'status':True, 'user_id':user.id, 'user_subscription_id':user_subscription.id}, safe=False)
