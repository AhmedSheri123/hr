...
urlpatterns = [
    ...
    path('AddHRByAPI', views.AddHRByAPI, name='AddHRByAPI'),
    path('GetHRManagementInfo/<int:id>', views.GetHRManagementInfo, name='GetHRManagementInfo'),
    path('DeleteHRManagementAPI/<int:id>', views.DeleteHRManagementAPI, name='DeleteHRManagementAPI'),
