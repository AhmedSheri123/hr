...
def correct_fuzzy_entries(language_code):
    ...
    locale_path = os.path.join('F:/mostql/rady-made-projects/HR/horilla-master2/horilla-master', 'locale', language_code, 'LC_MESSAGES', 'django.po')
    ...
    for entry in po_file:
        ...
        if 'fuzzy' in entry.flags:# or (entry.msgstr == ''):
