...
from horilla.models import BaseModel
...
class MultipleCondition(BaseModel):
    """
...
class ReimbursementMultipleAttachment(BaseModel):
    """
...
class PayrollGeneralSetting(BaseModel):
    """
...
class EncashmentGeneralSettings(BaseModel):
    """
...
class PayslipAutoGenerate(BaseModel):
    """
